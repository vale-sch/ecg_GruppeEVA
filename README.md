...
# To get started
- If you only want to test our demo, just click on this link in your oculus browser: [App](https://vale-sch.github.io/ecg_GruppeEVA/sprint3/index.html) 
...
- [SSL](https://medium.com/webisora/how-to-enable-https-on-live-server-visual-studio-code-5659fbc5542c)
